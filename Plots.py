...
file_path = r'C:\Users\User\Desktop\ML\eco2mix-national-tr.csv'
...
def year_with_highest_consumption(df):
    ...
    # Agréger par année et calculer la consommation totale
...
print("Année avec la consommation maximale:", max_consumption_year['year'])
print("Consommation maximale (MW):", max_consumption_year['consommation'])
